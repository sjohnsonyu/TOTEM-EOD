...
data_path_name=imputation_and_forecasting_data/electricity/electricity.csv
data_name=custom
random_seed=2021
pred_len=0
...
#   --enc_in 321\ 
#   --gpu $gpu\
#   --save_path "imputation/data/electricity"
...
#   --config_path imputation/scripts/electricity.json \
#   --model_init_num_gpus $gpu \
#   --data_init_cpu_or_gpu cpu \
#   --comet_log \
#   --comet_tag pipeline \
#   --comet_name vqvae_electricity \
#   --save_path "imputation/saved_models/electricity/mask_ratio_"$mask_ratio"/"\
...
python imputation/imputation_performance.py \
  --dataset electricity \
  --trained_vqvae_model_path "imputation/saved_models/electricity/mask_ratio_0.5/CD64_CW512_CF4_BS8192_ITR15000_seed2021_maskratio0.5/checkpoints/final_model.pth" \
