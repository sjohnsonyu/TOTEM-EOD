...
class ExtractData:
    ...
    def extract_data(self):
        ...
        print('enforce min and max vals of 0 and 1')
        x_train_in_revin_space_arr = np.clip(x_train_in_revin_space_arr, 0, 1)
        x_val_in_revin_space_arr = np.clip(x_val_in_revin_space_arr, 0, 1)
        x_test_in_revin_space_arr = np.clip(x_test_in_revin_space_arr, 0, 1)
        x_train_original_arr = np.clip(x_train_original_arr, 0, 1)
        x_val_original_arr = np.clip(x_val_original_arr, 0, 1)
        x_test_original_arr = np.clip(x_test_original_arr, 0, 1)
